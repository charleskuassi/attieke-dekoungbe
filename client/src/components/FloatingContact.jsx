    ...
    return (
        <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50 items-end">
            ...
            <button
                ...
                className="bg-yellow-500 hover:bg-yellow-600 text-white p-4 rounded-full shadow-xl transition transform hover:scale-110 flex items-center justify-center"
            ...
            <button
                ...
                className="bg-primary hover:bg-orange-700 text-white p-4 rounded-full shadow-2xl transition transform hover:scale-110 flex items-center justify-center animate-bounce-slow"
