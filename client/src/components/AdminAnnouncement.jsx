        ...
        <div className="bg-white rounded-xl shadow p-6 max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                        <h3 className="font-bold text-gray-800">Afficher la barre d'annonce</h3>
                        <p className="text-sm text-gray-500">Visible en haut de toutes les pages.</p>
                    </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="3"
                        className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-primary/50"
