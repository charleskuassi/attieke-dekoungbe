        ...
        <div className="flex flex-col">
            ...
            <section className="relative h-[80vh] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url("/images/delivery_packaging.jpg")' }}>
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-3xl">
                    <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight">
                        Le goût authentique <br /> <span className="text-primary">chez vous</span>
                    </h1>
            ...
            <section className="py-16 px-4 bg-white">
                <div className="container mx-auto text-center max-w-4xl">
                    <h2 className="text-3xl md:text-4xl font-serif font-bold text-text mb-6">Une tradition culinaire</h2>
            ...
            <section className="py-16 px-4 bg-orange-50 overflow-hidden">
                <div className="container mx-auto">
                    <div className="flex justify-between items-end mb-10">
                        <h2 className="text-3xl md:text-4xl font-serif font-bold text-text">Nos Stars</h2>
                        <Link to="/menu" className="text-primary font-bold hover:underline hidden md:block">Voir tout le menu</Link>
                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 absolute w-full">
                                    {getVisibleItems().map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="p-6">
                                                <h3 className="text-xl font-bold mb-2 font-serif truncate">{item.name}</h3>
                                                <p className="text-gray-600 mb-4 line-clamp-2">{item.description}</p>
                                                <div className="flex justify-between items-center">
                                                    <span className="text-xl font-bold text-primary">{item.price} FCFA</span>
                                                    <Link to="/menu" className="text-secondary font-bold hover:text-green-700">Commander</Link>
                                                </div>
                                            </div>
                                        </motion.div>
                                    ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1 text-left space-y-6">
                            <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary leading-tight">
                                L'Authenticité livrée <br /> <span className="text-gray-900">chez vous.</span>
                            </h2>
                            <p className="text-lg text-gray-600 leading-relaxed">
                            ...
                            <div className="flex items-center gap-4 text-primary font-bold">
                                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-primary"></div> Rapide</span>
                                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-primary"></div> Chaud</span>
                                <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-primary"></div> Soigné</span>
                            </div>
                            <Link to="/menu" className="inline-block bg-primary text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-orange-700 transition transform hover:-translate-y-1">
                                Commander pour livraison
                            </Link>
                        </div>
                        <div className="order-1 md:order-2 relative">
                            <div className="absolute inset-0 bg-orange-100 rounded-2xl transform rotate-3 scale-95 z-0"></div>
                            <img
