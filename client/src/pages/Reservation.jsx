        ...
        return (
            <div className="min-h-screen bg-orange-50 flex flex-col items-center justify-center p-4">
                <div className="bg-white p-8 rounded-2xl shadow-xl text-center max-w-md w-full animate-fade-in">
                    <div className="mx-auto bg-green-100 p-4 rounded-full w-20 h-20 flex items-center justify-center text-green-600 mb-6">
                        <CheckCircle size={48} />
                    </div>
                    <h2 className="text-3xl font-serif font-bold text-primary mb-2">Demande en attente !</h2>
                    ...
                    <button onClick={() => { setStatus('idle'); setFormData(initialState); }} className="text-primary font-bold hover:underline">
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 p-6 md:p-12 lg:p-16 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    <div className="mb-10 text-center md:text-left">
                        <span className="text-primary font-bold tracking-wider text-sm uppercase mb-2 block">Dîner sur place</span>
                        <h1 className="text-4xl font-serif font-bold text-gray-900 mb-4">Réserver votre table</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-primary/50 bg-gray-50"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full border border-gray-300 rounded-lg p-3 pl-10 focus:ring-2 focus:ring-primary/50 bg-gray-50"
                                    placeholder="+229..."
                                />
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full border rounded-lg p-3 pl-10 focus:ring-2 focus:ring-primary/50 bg-gray-50 ${timeError ? 'border-red-500 bg-red-50' : 'border-gray-300'}`}
                                        placeholder="20:00"
                                    />
                                </div>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1">Demande spéciale</label>
                            <textarea
                                name="message"
                                rows="3"
            ...
            <div className="hidden md:block w-1/2 relative bg-gray-900">
                <img
                    src="/images/restaurant_interior.jpg"
                    alt="Intérieur Restaurant Attiéké Dékoungbé"
